In this folder I will include a notebook where I will be creating a recommendation system using LLaVa-NeXT-Video, a Large Vision-Language Model (LVM) that can ingest videos, 
